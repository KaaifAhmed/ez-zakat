...
const DashboardPage = ({
  ...
  let remainingBalance = Math.round(totalDue - amountPaid);
  ...
  const handleSavePayment = async () => {
    ...
    const enteredAmount = Math.round(parseFloat(formData.amount));
        ...
        <main className="flex-1 p-6">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <Button variant="outline" size="lg" onClick={() => navigate('/calculator')} className="flex-1 border-border text-foreground hover:bg-accent hover:text-accent-foreground p-2 ">
